                        ...
                        <form action="{{ route('admin.voter.PrepareVoterListGenerate') }}" method="post" target="blank">
                            ...
                            <div class="card-body">
                                <div class="row">  
                                    ...
                                    <div class="col-lg-3 form-group">
                                       <input type="submit" class="btn btn-success form-control" value="Process And Lock">
                                   </div>
                                   <div class="col-lg-3 form-group">
                                       <input type="submit" class="btn btn-danger form-control" value="Unlock">
                                   </div>
                                   <div class="col-lg-3 form-group">
                                       <input type="submit" class="btn btn-primary form-control" value="Print Complete Village">
                                   </div>
                                   <div class="col-lg-3 form-group">
                                       <input type="submit" class="btn btn-info form-control" value="Print Complete Ward">
                                   </div>
                                    </div>
                                </div> 
                        </form>
